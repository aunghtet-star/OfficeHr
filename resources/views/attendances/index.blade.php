...
<a href="{{route('attendances.create')}}" class="btn btn-theme btn-sm m-0 mb-3"><i class="fas fa-plus-square mr-1"></i> Create Attendance</a>
@endcan
    ...
    <script>
        $(function() {
            var table = $('.datatable').DataTable({
                ...
                ajax: '/attendances/datatables/ssd',
                columns: [
